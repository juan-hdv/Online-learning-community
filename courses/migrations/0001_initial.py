    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('extraprice', models.FloatField(default=0.0)),
                ('addcod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.CourseAdd')),
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='courses.OrderItem')),
            ],
        ),
        migrations.CreateModel(
            name='CourseCategory',
